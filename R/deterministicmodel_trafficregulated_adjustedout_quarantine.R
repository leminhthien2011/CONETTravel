...
#'  deterministicmodel_trafficregulated_adjustedout_quarantine(theta0, inp)
...
deterministicmodel_trafficregulated_adjustedout_quarantine =  function(thetamatrix, inp){

...
#' @param travel travel data in total
#' @param d duration travel
#' @param ratein  rate people can get in the country
#' @importFrom stats rpois
#' @export
stofunc_travel3_rateshutdown =  function(ini, thetas , travel, d, ratein){
  ...
  for (i in 2:d){
    ...
    ########
    update = status_matrix[i,]  +  ratein*f_in[i,] - f_out[i,]
    update[update<0.1]=0

...
#' stochastic_postquarantine_wholeprocess(theta0,inp)}
#' @export




stochastic_postquarantine_wholeprocess = function(theta,inp){
  n1 = 2 + inp$durationquarantine # Adjust for 0 and 1 days quarantine
